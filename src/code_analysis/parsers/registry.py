"""Language parser protocol and registry implementation.

Split out of parsers/__init__.py (plan 021 WP-H) so the package init stays
to docstring + re-exports only, per rule 001.3.
"""
